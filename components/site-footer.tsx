...
export function SiteFooter() {
    return (
        <footer className="bg-gray-100/40">
            <div className="px-8 py-5">
                <div className="flex justify-between">
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold">关于我们</h3>
                        <p className="text-sm text-gray-500">我们就像您身边的超级助手，专注于英语和口语，让学习变得轻松又有趣！😎</p>
                        <div className="flex space-x-3">
                            <Link href="https://x.com/gzqxndev" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                            ...
                            <Link href="https://space.bilibili.com/440888204?spm_id_from=333.1007.0.0" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                            ...
                            <Link href="https://github.com/bookmarkbao" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                                <Github size={20} />
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link href="https://web.tsdanci.com" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                                    图舌单词官网
                                </Link>
                            </li>
                            <li>
                                <Link href="https://ju.deepdanci.com" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                                    语音句型跟读
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link href="https://peiyin.deepdanci.com" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                                    在线角色配音
                                </Link>
                            </li>
                            <li>
                                <Link href="https://deploy-html.deepdanci.com" className="text-gray-500 hover:text-[#FF6600] transition-colors">
                                    在线HTML部署
                                </Link>
                            </li>
                        </ul>
                ...
                <Separator className="my-8 bg-gray-300/20" />
                <div className="flex items-center justify-between">
                    <p className="text-center text-sm text-gray-500 md:text-left hidden">
